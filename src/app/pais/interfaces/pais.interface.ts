...
export class Convert {
    public static toEmpty(json: string): Pais[] {
        return cast(JSON.parse(json), a(r("Empty")));
    }

    public static emptyToJson(value: Pais[]): string {
        return JSON.stringify(uncast(value, a(r("Empty"))), null, 2);
    }
}
